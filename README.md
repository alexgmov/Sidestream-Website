...
- Confirm the hero `Download for Windows` link visually matches the Mac Free Download pill, uses a Windows mark instead of the Apple mark, points exactly at `https://sidestream.tv/api/download?platform=win32-x64`, starts the Windows installer without opening the historical waitlist modal, and does not change the Mac download CTA.
