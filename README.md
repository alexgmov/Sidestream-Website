...
- 2026-07-15: Prepared the stable Mac `1.0.14` release manifest for the signed/notarized `Sidestream-1.0.14-Mac-Installer.dmg` at the private versioned Blob pathname, with SHA-256 `09d31bd4373f030184593f2cae361f776b82bf1552b0b543bc15be1a30c1c79e`; public `/api/download` and `/api/releases/latest` verification remains required after the `main` deployment.
