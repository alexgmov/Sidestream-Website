...
- `docs/api-hardening-runbook.md` - Exact hardened API/release contract, shared Postgres and migration model, Stripe/lead/maintenance operations, bounded configuration, metrics and alerts, required webhook events, and the ordered human-gated production cutover plus forward-compatible rollback. It does not claim production was changed.
