...
- `api/_lib/account.ts` - Shared server-only account, Google OAuth, Stripe, Postgres, activation, license-token, cookie, and response helpers for the SaaS flow.
