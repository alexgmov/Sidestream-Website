...
- Closing panel - `.final` sits inside `#pricing` between the pricing cards and laptop mockup, with headline and supporting copy only; download actions remain in the hero and Free pricing card
...
- 2026-07-28: Removed the Mac `Free Download` button from the closing "Stop using sketchy websites to download music" panel while preserving its headline, supporting copy, and the download controls in the hero and Free pricing card.
