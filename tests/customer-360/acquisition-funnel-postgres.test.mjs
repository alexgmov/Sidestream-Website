...
test("acquisition funnel keeps attribution exact and retention UTC-day based", {
  ...
  try {
    ...
    assert.deepEqual(paidGroup, {
      ...
      experiment: "meta-direct-links-v1",
      cohort: "paid",
