...
test("paid acquisition accepts Stripe-verified discount totals and rejects mismatches", () => {
  ...
  const expectation = { amountSubtotal: 1999, currency: "usd" };
  assert.equal(
    isValidDiscountedCheckoutPayment(
      discountedCheckout,
      { amountPaid: 1699, currency: "usd" },
      expectation,
    ),
    true,
  );
  ...
  const rejected = [
    [{ ...discountedCheckout, payment_status: "unpaid" }, { amountPaid: 1699, currency: "usd" }],
    [{ ...discountedCheckout, amount_subtotal: 999 }, { amountPaid: 1699, currency: "usd" }],
    [{ ...discountedCheckout, amount_total: 0, total_details: { ...discountedCheckout.total_details, amount_discount: 1999 } }, { amountPaid: 0, currency: "usd" }],
    [{ ...discountedCheckout, total_details: { ...discountedCheckout.total_details, amount_discount: 299 } }, { amountPaid: 1699, currency: "usd" }],
    [{ ...discountedCheckout, total_details: { ...discountedCheckout.total_details, amount_tax: 1 } }, { amountPaid: 1699, currency: "usd" }],
    [discountedCheckout, { amountPaid: 1700, currency: "usd" }],
    [discountedCheckout, { amountPaid: 1699, currency: "eur" }],
  ];
