...
if (
  ...
  console.error(
    "Usage: npm run replay:paid-telemetry-handoff -- [--expect-broken|--expect-pending-review-repaired]",
  );
  process.exitCode = 1;
} else {
  const expectation = options.includes("--expect-pending-review-repaired")
